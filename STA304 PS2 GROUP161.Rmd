...
Github Link: https://github.com/HairuoWang/Sta-304-PS2-GREOUP161
...
model_coefficient = kable(summary(model_2017)$coefficients, caption = "Summary 
                          of Model", digits = 3, format = "markdown")
model_coefficient
```
